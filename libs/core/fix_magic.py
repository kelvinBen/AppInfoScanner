#! /usr/bin/python3
# -*- coding: utf-8 -*-
# AppInfoScanner v1.0.10 增强模块：dex/zip 魔数检测与修复
#
...
# 或作为模块调用：
#   from libs.core.fix_magic import detect, fix_dex
#
...
def detect(path):
    ...
    if status.get("type") == "dex":
        ...
        if problems:
            ...
            print("    run: python3 libs/core/fix_magic.py fix dex {}".format(path))
        else:
